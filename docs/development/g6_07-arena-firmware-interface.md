...
- **2026-05-02** — Partial gh-api KiCad trace (Open Qs #4, #5): MCP4725 schematic uses generic part symbol (`xxx-xCH`); BOM lookup → LCSC C144198 = MCP4725A0T-E/CH = base I²C address `0x60` (A0-pin wiring TBD from schematic). SN74LVC1T45 instances confirmed at `teensy.kicad_sch` U2/U3; DIR-net trace deferred to local KiCad inspection (commit `9a87336` + this commit).
