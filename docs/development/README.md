...
| [`g6_arena_configs.h`](g6_arena_configs.h) | — (controller-side panel map, keyed by Arena ID) | **Stepping-stone (hand-maintained 2026-05-14)** | Mirrors `g6_07` SPI/CS tables + `Generation 6/maDisplayTools/configs/arena_registry/`. Drafted codegen + sibling hardware YAML live in the submodule at `Generation 6/maDisplayTools/{tools/gen_arena_configs.py, configs/arena_hardware/G6_2x10.yaml}` — both **untested, awaiting validation**. See [`g6_docs-open-issues.md`](g6_docs-open-issues.md) § D. |
